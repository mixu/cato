...
function CollectionView() {
  ...
  this._outlet._el = function(outlet) {
    self.id = outlet.id = $.id();
    return $.el('table', { id: outlet.id }, '<tr><th>Project Name</th><th>Data Set</th><th>Script</th><th>Sample</th><th>Last modified</th></tr>');
  };
